...
import "https://raw.githubusercontent.com/broadinstitute/CTAT-VirusIntegrationFinder/Terra-1.2.3-dev/WDL/Terra/ctat_VIF.Terra.wdl" as ctat_VIF_Terra
...
workflow ctat_VIF_Terra_hg38 {
  ...
  input {
    ...
    CTAT_VIF_config pipe_inputs_config = {
	  ...
	  "star_index_human_plus_virus" : "gs://ctat_genome_libs/GRCh38_gencode_v22/06-06-2022/hg_plus_viraldb.fasta.star.idx.tar",      
