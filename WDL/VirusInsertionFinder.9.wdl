...
task CTAT_VIF {
    ...
    output {
        ...
        File vif_prelim_insertion_candidates_tsv = "~{output_prefix}.prelim.abridged.tsv"
        File vif_prelim_insertion_candidates_png = "~{output_prefix}.prelim.abridged.tsv.genome_plot.png"
