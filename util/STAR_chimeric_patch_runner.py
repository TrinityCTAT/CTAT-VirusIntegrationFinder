...
def main():
    ...
    optional.add_argument("--genome", type=str, help="STAR index directory", required=True)
    ...
    star_genome = args_parsed.genome
    ...
    if not os.path.exists(star_genome):
        sys.stderr.write("Error, {} not found".format(star_genome))
        sys.exit(1)
